    ...
    if(END_POINT) {
      ...
      1 == e("#light-mode-switch").prop("checked") && "light-mode-switch" === t
        ? (e("html").removeAttr("dir"),
          ...
          e("#bootstrap-style").attr("href", n + "admin/assets/css/bootstrap.min.css"),
          e("#app-style").attr("href", n + "admin/assets/css/app.min.css"),
          sessionStorage.setItem("is_visited", "light-mode-switch"))
        : 1 == e("#dark-mode-switch").prop("checked") && "dark-mode-switch" === t
        ? (e("html").removeAttr("dir"),
          e("#light-mode-switch").prop("checked", !1),
          e("#rtl-mode-switch").prop("checked", !1),
          e("#bootstrap-style").attr("href", n + "admin/assets/css/bootstrap-dark.min.css"),
          e("#app-style").attr("href", n + "admin/assets/css/app-dark.min.css"),
